...
<% 
    ...
    ResultSet res = contractDetail.getContractLevel0(uid);
		        ...
		        <tbody>
		          ...
		          if(flag)
		          {
						...
						{		
							...
							%>
							<td>
							   <a href = "addContractFromBox.jsp?param1=<%=str1[i]%>&param2=<%=str2[i]%>"> 
									<img src="images/icon-edit.png"  alt="Alter" />
									Alter
								</a>
							        <form action="dele" method="post">
									<img src="images/delete.png"  alt="Delete" />
									<input  type="hidden" name="cid" value="<%=str1[i] %>">
