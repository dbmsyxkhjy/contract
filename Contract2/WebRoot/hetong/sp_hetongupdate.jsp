...
<script language="javascript" type="text/javascript" src="js/jquery.min.js"></script>
	...
	<body>
<form action="method!sp_hetongupdate2" method="post"  >
<input type="hidden" name="id" value="${bean.id }"/>
    <div id="regdiv">
         <div id="forms" class="mt10">
        <div class="box">
          <div class="box_border">
            <div class="box_top"><b class="pl15">合同审批</b></div>
            <div class="box_center">
               ...
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="td_right">审批:</td>
                  <td>
                   <span class="fl">
                      <div class="select_border"> 
                        <div class="select_containers "> 
                        <select  name="stauts" id="stautsid" class="select"> 
                         <option value="审批通过">通过</option>
                         <option value="审批不通过">不通过</option>
                        </select> 
                        </div> 
                      </div> 
                    </span>
